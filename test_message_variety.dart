...
void main() {
  ...
  print(
      'Variety rate: ${(uniqueMessages.length / 100 * 100).toStringAsFixed(1)}%');
  ...
  final speedMessage =
      MessageVarietyEngine.getSimpleVarietyMessage('speed', 20);
  print('Speed message: $speedMessage');

  final competitiveMessage =
      MessageVarietyEngine.getSimpleVarietyMessage('competitive', 25);
  print('Competitive message: $competitiveMessage');

  final achievementMessage =
      MessageVarietyEngine.getSimpleVarietyMessage('achievement', 30);
  print('Achievement message: $achievementMessage');

  final precisionMessage =
      MessageVarietyEngine.getSimpleVarietyMessage('precision', 35);
