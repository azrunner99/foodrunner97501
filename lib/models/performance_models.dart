...
class NPSData {
  ...
  final Map<String, double> categoryBreakdown; // service, food, atmosphere, etc.
  ...
  static NPSData fromMap(Map<String, dynamic> map) => NPSData(
    ...
    categoryBreakdown: Map<String, double>.from(
      (map['categoryBreakdown'] as Map).map((k, v) => MapEntry(k.toString(), (v as num).toDouble()))
    ),
...
class EnhancedMonthlyBusinessData {
  ...
  static EnhancedMonthlyBusinessData fromMap(Map<String, dynamic> map) => EnhancedMonthlyBusinessData(
    month: DateTime.parse(map['month'] as String),
    totalGuests: map['totalGuests'] as int,
    totalSales: (map['totalSales'] as num).toDouble(),
    serverNPSData: (map['serverNPSData'] as Map).map(
      (k, v) => MapEntry(k.toString(), NPSData.fromMap(v as Map<String, dynamic>))
    ),
    restaurantNPSAverage: (map['restaurantNPSAverage'] as num).toDouble(),
    serverShiftCounts: Map<String, int>.from(map['serverShiftCounts'] as Map),
    serverSalesShare: Map<String, double>.from(
      (map['serverSalesShare'] as Map).map((k, v) => MapEntry(k.toString(), (v as num).toDouble()))
    ),
    lastUpdated: DateTime.parse(map['lastUpdated'] as String),
  );
}
...
class MonthlyBusinessData {
  ...
  static MonthlyBusinessData fromMap(Map<String, dynamic> map) => MonthlyBusinessData(
    month: DateTime.parse(map['month'] as String),
    totalGuestCount: (map['totalGuestCount'] as num).toDouble(),
    totalSales: (map['totalSales'] as num).toDouble(),
    serverSpecificGuests: Map<String, double>.from(map['serverSpecificGuests'] ?? {}),
    serverSpecificSales: Map<String, double>.from(map['serverSpecificSales'] ?? {}),
...
class PerformanceInsight {
  ...
  static PerformanceInsight fromMap(Map<String, dynamic> map) => PerformanceInsight(
...
class ServerPerformanceData {
  ...
  static ServerPerformanceData fromMap(Map<String, dynamic> map) => ServerPerformanceData(
    serverId: map['serverId'] as String,
    ...
    totalGuestCount: (map['totalGuestCount'] as num).toDouble(),
    totalSales: (map['totalSales'] as num).toDouble(),
    shiftTypes: (map['shiftTypes'] as List).map((s) => ShiftComplexity.fromMap(s)).toList(),
    ...
    flags: (map['flags'] as List).map((f) => PerformanceFlag.values[f as int]).toList(),
    insights: (map['insights'] as List).map((i) => PerformanceInsight.fromMap(i)).toList(),
  ...
  bool get needsAttention => rating == PerformanceRating.needsAttention || 
