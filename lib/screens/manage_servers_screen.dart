...
class _ManageServersScreenState extends State<ManageServersScreen> {
          ...
          TextButton.icon(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const ArchivedServersScreen()),
              );
            },
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      ...
                      await _addServerWithBirthday(
                          context, _nameCtrl.text.trim());
                      _nameCtrl.clear();
                    },
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ElevatedButton.icon(
                                          ...
                                          icon: Icon(profile.isArchived
                                              ? Icons.restore_outlined
                                              : Icons.archive_outlined),
                                          label: Text(profile.isArchived
                                              ? 'Restore'
                                              : 'Archive'),
                                          style: ElevatedButton.styleFrom(
  ...
  Future<void> _addServerWithBirthday(
  ...
  Future<String?> _showArchiveDialog(
      BuildContext context, String serverName) async {
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    'e.g., Left the restaurant, poor performance, requested transfer...',
                border:
