                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Expanded(
                                            child: Container(
                                              padding: (profile.bannerPath?.isNotEmpty ?? false)
                                                  ? const EdgeInsets.symmetric(horizontal: 8, vertical: 4)
                                                  : null,
                                              decoration: (profile.bannerPath?.isNotEmpty ?? false)
                                                  ? BoxDecoration(
                                              ...
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  color: (profile.bannerPath?.isNotEmpty ?? false)
                                                      ? Colors.white
                                                      : Colors.grey.shade600,
                                                  shadows: (profile.bannerPath?.isNotEmpty ?? false)
                                                      ? [
                                                          Shadow(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: ElevatedButton.icon(
                                          onPressed: () => _restoreServer(context, server),
