        ...
        child: ListView(
          ...
          children: [
            _buildVersionCard(
              ...
              color: Colors.green,
              changes: [
                "🧠 MAJOR: Advanced NPS Analytics & Performance Intelligence System",
                "📊 Historical NPS Analytics: Comprehensive multi-month performance analysis with trend detection and pattern recognition",
                "🤖 Intelligent Performance Classification: AI-powered server performance tiers (Elite, Strong, Developing, Concerning, Critical) with multi-dimensional scoring",
                "📈 Advanced Trend Analysis: Sophisticated trend analysis with velocity tracking, strength measurement, and predictive insights",
                "⚡ Performance Velocity Tracking: Rate of change analysis with acceleration metrics and momentum classification (7 types from Strong Positive to Strong Negative)",
                "🎯 Trend Strength & Reliability: R-squared analysis for trend reliability scoring (0-100%) with confidence intervals and uncertainty quantification",
                "🔮 Predictive Performance Analytics: 3-month and 6-month performance projections with confidence levels and sustainability assessment",
                "⚖️ Multi-Dimensional Scoring: Weighted performance factors including recent performance (30%), historical consistency (25%), improvement trend (20%), data quality (15%), and tenure (10%)",
                "🧩 Contextual Intelligence: Incorporates shift complexity, seasonal patterns, performance velocity, and volatility into classifications",
                "📊 Benchmark Comparisons: Performance benchmarking against industry standards with peer ranking and comparative analysis",
                "📉 Volatility Assessment: Performance stability measurements with standard deviation analysis and consistency scoring",
                "⏱️ Trend Persistence Tracking: Analysis of how long trends have been consistent with reliability scoring",
                "💡 Actionable Insights & Recommendations: Contextual guidance based on trend patterns, momentum, and performance confidence levels",
                "🔍 Data Quality Classification: Automatic data quality assessment (Complete, Partial, Sparse, Missing) with confidence levels",
                "📅 Performance Timeline Service: Individual server performance tracking over time with trend direction analysis",
                "✅ Historical Data Validation: Data completeness checks and integrity validation for historical performance data",
                "🔗 Unified Data Service: Consolidates data from multiple sources (AppState, NPS DB, Enhanced Business Data) for accurate analysis",
                "🧮 Enhanced Performance Calculator: Advanced algorithms for data quality, confidence levels, and temporal analysis",
                "📊 Server Performance Analytics & Monitoring: Real-time monitoring dashboard with alerts and comprehensive reporting",
                "🚀 Performance Rollout Management: Phased rollout system for new performance features with validation and reconciliation",
                "🔧 Data Consistency Service: Cross-system data validation ensuring accuracy across different data sources",
                "🛡️ Enhanced Error Handling: Centralized error logging, recovery mechanisms, and user-friendly error notifications",
                "🔄 Fallback Mechanisms: Robust fallback data and recovery systems for unavailable or inconsistent data",
                "🚩 Performance Flags System: Feature flag management for gradual rollout of new performance features",
                "⚙️ Adaptive Weighting Strategies: Dynamic performance scoring that adapts based on data quality and historical patterns",
                "📊 Confidence Interval Analysis: Statistical confidence intervals for performance metrics with uncertainty quantification",
                "⏰ Temporal Analysis: Time-weighted scoring with seasonal adjustments and performance velocity calculations",
                "🔍 Performance Anomaly Detection: Identification of unusual performance patterns and outlier detection",
                "📋 Comprehensive Reporting: Detailed performance reports with insights, recommendations, and trend analysis",
                "🎨 Enhanced UI Integration: Rich visual displays for trend analysis with color-coded metrics and interactive charts",
                "⚡ Performance Optimization: Improved data processing and analysis algorithms for faster insights",
                "🔧 Technical Infrastructure: Advanced analytics foundation supporting future AI and machine learning enhancements",
              ],
            ),
            _buildVersionCard(
              version: "3.5.0+350",
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildStatRow('Total Commits',
                      '360+ commits (build number reflects commit count)'),
                  _buildStatRow('Version Milestones',
                      '6 major versions (Foundation → Team System → Gamification → Enhanced UX → Security Intelligence → NPS Analytics Intelligence)'),
                  ...
                  _buildStatRow('Features Added',
                      '30+ documented features across 6 major revisions including advanced NPS analytics and performance intelligence'),
                ],
              ),
            ),
          ],
    ...
    return Container(
      ...
      child: ExpansionTile(
        ...
        initiallyExpanded: version
            .contains("3.6.0"), // Only expand the latest version by default
        title: Container(
